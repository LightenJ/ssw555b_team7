...
try:
    ...
    print("\nUS29 ==> List of deceased individuals is : \n", validity_test.list_of_deceased_individuals(individuals))
    ...
    print("\nUS34 ==>List large age differences : \n", validity_test.List_large_age_differences(individuals,families))
    ...
    print("\nUS41 ==> Accept partial dates : \n", validity_test.us41_accept_partial_dates(individuals, families))    
